...
public enum ErrorCode {
    ...
    // JUST ADD ANOTHER FOR TESTING
    TABLE_POSITION_INVALID(400, "Vị trí bàn không hợp lệ", HttpStatus.BAD_REQUEST),
    TABLE_POSITION_INTERSECT(400, "Vị trí bàn bị trùng lặp", HttpStatus.BAD_REQUEST);
